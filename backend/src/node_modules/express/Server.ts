...
export default class Server {
    ...
    public listen(port: number) {
        ...
        this.listener.use(connectDomain());
        ...
        this.listener.use("/public/", this.exp.static(MakeUtil().uploadDirectory));
        this.listener.use("/tmp/", this.exp.static(MakeUtil().tmpDirectory));
        
        this.logger.info("---", "PETS FOREVER BACKEND SERVER IS RUNNING ON", port, "---");
    }
